...
IMPORT(MCP_Open);
IMPORT(MCP_Close);
IMPORT(MCP_InstallSetTargetDevice);
IMPORT(MCP_InstallGetTargetDevice);
IMPORT(MCP_InstallSetTargetUsb);
IMPORT(MCP_InstallGetInfo);
IMPORT(MCP_InstallTitleAsync);
IMPORT(MCP_InstallGetProgress);
IMPORT(MCP_InstallTitleAbort);
IMPORT(MCP_UninstallTitleAsync);
IMPORT(MCP_DeviceList);
IMPORT(MCP_FullDeviceList);
...
IMPORT(ProcUISubProcessMessages);
...
IMPORT(SYSSwitchToSyncControllerOnHBM);
IMPORT(SYSSwitchToEManual);
IMPORT(SYSSwitchToEShop);
IMPORT(_SYSSwitchToMainApp);
IMPORT(SYSSwitchToBrowserForViewer);
IMPORT(SYSSwitchToBrowser);
IMPORT(SYSSwitchToBrowserForCallbackURL);
